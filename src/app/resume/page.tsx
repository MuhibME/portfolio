...
const about = { 
  title: 'About me',
  description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic praesentium ipsam numquam quia nam vitae dignissimos vero iste et. Unde distinctio sequi minima fuga odio placeat eius illo autem iste.",
  info: [
    {
    fieldName: 'Name',
    fieldValue: 'Muhib Mehboob'
  },
  {
    fieldName: 'Phone',
    fieldValue: '(+92) 317 2912 659'
  },
  {
    fieldName: 'Email',
    fieldValue: 'muhibkmehboob@gmail.com'
  },
  {
    fieldName: 'Freelance',
                ...
                {education.info.map((item,index)=>{
                  return (
                    <li key={index} className='bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center xl:items-start gap-1'>
                      ...
                      <div className='flex items-center gap-3'><span className='w-[6px] h-[6px] rounded-full bg-accent'></span><p className='text-white/60'>{item.institiute}</p></div>
                    </li>
                  )
                })}
              </ul>
